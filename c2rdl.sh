...
cd /home/runner/work/C2R/C2R/$URL/$FFN40/$DIR/ && cabextract -q v64.cab
cd /home/runner/work/C2R/C2R/$URL/$FFN41/$DIR/ && cabextract -q v64.cab
cd /home/runner/work/C2R/C2R/$URL/$FFN42/$DIR/ && cabextract -q v64.cab
...
VER22=`grep Available /home/runner/work/C2R/C2R/$URL/$FFN22/$DIR/VersionDescriptor.xml | awk -F "\"" '{print $2}'`
VER23=`grep Available /home/runner/work/C2R/C2R/$URL/$FFN23/$DIR/VersionDescriptor.xml | grep Default | awk -F "\"" '{print $4}'`
VER24=`grep Available /home/runner/work/C2R/C2R/$URL/$FFN24/$DIR/VersionDescriptor.xml | grep Default | awk -F "\"" '{print $4}'`
VER25=`grep Available /home/runner/work/C2R/C2R/$URL/$FFN25/$DIR/VersionDescriptor.xml | awk -F "\"" '{print $2}'`
...
VER40=`grep Available /home/runner/work/C2R/C2R/$URL/$FFN40/$DIR/VersionDescriptor.xml | grep Default | awk -F "\"" '{print $4}'`
VER41=`grep Available /home/runner/work/C2R/C2R/$URL/$FFN41/$DIR/VersionDescriptor.xml | grep Default | awk -F "\"" '{print $4}'`
VER42=`grep Available /home/runner/work/C2R/C2R/$URL/$FFN42/$DIR/VersionDescriptor.xml | grep Default | awk -F "\"" '{print $4}'`
...
TIME40=`stat --printf=%y /home/runner/work/C2R/C2R/$URL/$FFN40/$DIR/v64.cab | awk -F "\." '{print $1}'`
TIME41=`stat --printf=%y /home/runner/work/C2R/C2R/$URL/$FFN41/$DIR/v64.cab | awk -F "\." '{print $1}'`
TIME42=`stat --printf=%y /home/runner/work/C2R/C2R/$URL/$FFN42/$DIR/v64.cab | awk -F "\." '{print $1}'`
